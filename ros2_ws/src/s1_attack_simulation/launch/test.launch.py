#!/usr/bin/env python3
"""
Launch file for test phase (using poisoned context)
"""
...
def generate_launch_description():
    """Generate launch description for test phase missions."""
    ...
    # UAV Agent Node (test mode with poisoned context)
    uav_agent_node = Node(
        ...
        parameters=[
            config_file,
            {
                'mode': 'test',
                'llm_model': 'mock',
                # Use the poisoned context from injection phase
                'context_storage_path': '~/.ros2_s1_attack/context_injection'
            }
        ]
    )
